...
| SMPL+H    | Hand model                                            | https://mano.is.tue.mpg.de/  |
| MANO      | Human body + hand model (without face articulation)   | https://mano.is.tue.mpg.de/  |
...
1. **[SMPL-X part segmentation](../assets/SMPL_body_segmentation/smplx/smplx_vert_segmentation.json)**
